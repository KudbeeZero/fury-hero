...
export class Backend implements backendInterface {
    ...
    async addSong(arg0: SongInput): Promise<void> {
    ...
    async submitScore(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: number, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitScore(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
